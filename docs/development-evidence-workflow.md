...
The canonical committed development ledger is [`development/INDEX.md`](../development/INDEX.md). At the time of this update, committed development extends through **D-040**. Current authorized-but-not-yet-committed work is tracked by the relevant GitHub authorization issue/PR rather than predicted in this workflow document; D-041 is currently authorized by issue #140.
