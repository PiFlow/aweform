...
This boundary was written for V0.1 and applies unchanged through V0.2, V0.3, and V0.4. ADR 0009 opened V0.2 by permitting bounded one-step observation-history state inside a controller. ADR 0010 opens V0.3 by permitting bounded lifetime plastic/learned state whose causal writes obey the sensory/plasticity provenance boundary. ADR 0012 opens V0.4 by permitting a bounded physically grounded simulator energy/thermal model. None of those ADRs changes anything this document allows or forbids.
