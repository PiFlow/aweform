...
Committed D-series development currently extends through **D-050**. D-041 completed the evaluator-only sensory-sufficiency audit; D-042→D-044 closed the V0.4 embodiment/docking line; D-045 committed the deterministic V0.5 substrate; D-046 introduced the fresh 528-weight shadow consequence learner; D-047 audited held-out action-consequence discrimination; D-048 tested extended exposure of that unchanged learner across eight continuous curriculum passes; D-049 implemented a programmed Level-1 direct-return/contact-seeking docking core; and D-050 compared that unchanged stop-turn-straight baseline against a deterministic smooth curved-pursuit alternative on fresh paired fixed states. Predictions through D-048 remain shadow-only and have no causal behavioral role; D-049/D-050 return behaviour is explicitly programmed/engineered Level-1 competence, not learned competence. The exact committed ledger is [`development/INDEX.md`](development/INDEX.md).

No successor D-stage is authorized merely by D-050, ADR 0018, the roadmap, or conversation context. For any new work, read the exact current GitHub authorization issue/PR and current `main` SHA. D-049 and D-050 are committed in-boundary Level-1 Development records under ADR 0018; neither the planned D-050 trajectory visualizer nor a return-margin/energy-trigger implementation is authorized without a fresh exact-base authorization.
