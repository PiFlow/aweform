# Aweform Development Index

This directory records fast, descriptive `D-NNN` development work.

Development records are not confirmatory evidence. They may motivate a later `EXP-NNN` protocol, but they do not count as evidence for that later claim.
...
| D-046 | One-time raw-wheel calibration and fresh V0.5 shadow consequence learning | CONTINUING | [`D-046-v05-calibration-shadow-consequence-learning.md`](D-046-v05-calibration-shadow-consequence-learning.md) |
...
| D-051 | D-050 baseline numerical switching attribution audit (correction pass; prior result invalidated) | BLOCKED | [`D-051-d050-baseline-numerical-switching-attribution-audit.md`](D-051-d050-baseline-numerical-switching-attribution-audit.md) |
