...
Per-decision L/F/R rows use the accepted D-035B lossless binary-row encoding;
reverse-decision rows use a deterministic fixed-width binary encoding. Both
