...
## Invalidated prior execution provenance

The prior D-051 execution from executable SHA
`98b9ca83c86b5b5ab55049cc8ad818801222d1ab` is invalidated. Its artifact was
`55,956,563` bytes with SHA-256
`3abbf9c8c3cbaf495269df2228086a2365cd29228fecd52cb4538feb90f79904`.
The protocol defect was that
`original_threshold_turn_uncertainty_treatment_straight` used Arm B's active
effective tolerance; Arm A therefore reported zero counterfactual treatment
transitions instead of evaluating the issue-defined treatment independently.
The historical and fresh outputs from that execution are not pooled into the
corrected interpretation. This correction preserves the invalidated artifact
and will rerun both frozen supports from a new clean executable/protocol SHA.
