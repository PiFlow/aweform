...
- **corrected protocol freeze SHA:** `51c5f5867d4bd7aac2fac3544b4c62c73a21dd4c`
- **artifact:** `D-037-endogenous-prediction-state-recruitment-signal-audit.json`
- **artifact SHA-256:** `7247c012487673a0125723313863df91829d62abe0abc335096222b7e391019c`
- **artifact size:** `597339` bytes
...
No fresh Development or EXP seeds were used. The corrected artifact was
...
`0.0155, 0.0183, -0.0058, -0.0113, -0.0260, -0.0036` at horizon `64`,
`0.0159, 0.0195, -0.0047, -0.0096, -0.0268, -0.0028` at `256`, and
`0.0173, 0.0216, -0.0028, -0.0076, -0.0273, -0.0014` at `1024`.
...
|---:|---:|---:|---:|
| 64 | `0.0006975 / 0.0645` | `0.0019185 / 0.1068` | `+0.0012210` |
| 256 | `0.0007009 / 0.0654` | `0.0019250 / 0.1082` | `+0.0012242` |
| 1024 | `0.0007216 / 0.0661` | `0.0019219 / 0.1066` | `+0.0012002` |

The augmented model's higher correlation did not translate into lower error:
the augmented MAE was worse on 19/20 held-out seeds at horizon 64, 19/20 at
